...
public class ArcMenu extends RelativeLayout {
    ...
    OnTouchListener userOnTouch = null;
    public void setControlTouchListener(OnTouchListener l)
    {
        userOnTouch = l;
    }

    public void setHintViewImage(int resId)
    {
    ...
    public void closeMenu()
    {
        if(mArcLayout.isExpanded()) {
            itemDidDisappear();
            mHintView.startAnimation(createQuickHintSwitchAnimation(true));
        }
    }
