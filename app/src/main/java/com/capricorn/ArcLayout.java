...
public class ArcLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final int size = radius * 2 + mChildSize + mChildPadding + mLayoutPadding * 2 + mChildSize;
    ...
    private void bindChildAnimation(final View child, final int index, final long duration) {
        ...
        Log.e("Arcmenu", "mExpanded = " + mExpanded + ",startOffset = " + startOffset + ",toXDelta = " + toXDelta + ",toYDelta=" + toYDelta);
    ...
    public void switchStateInt(final boolean showAnimation,int dur) {
        if (showAnimation) {
            final int childCount = getChildCount();
            for (int i = 0; i < childCount; i++) {
                bindChildAnimation(getChildAt(i), i, dur);
            }
        }
    ...
    public void switchState(final boolean showAnimation) {
        switchStateInt(showAnimation, 300);
    }
