...
public class MenuPopupWindow {
	 ...
	 */
	public MenuPopupWindow(View anchor) {
		this.anchor = anchor;
		...
		window.setTouchInterceptor(new OnTouchListener() {
			public boolean onTouch(View v, MotionEvent event) {
				if (event.getAction() == MotionEvent.ACTION_OUTSIDE) {
					MenuPopupWindow.this.window.dismiss();
	...
	public void showDropDown(int xOffset, int yOffset) {
		...
		window.setAnimationStyle(getRService().getStyle("Animations.PopDownMenu"));
	...
	public void showLikeQuickAction(int xOffset, int yOffset) {
		...
		window.setAnimationStyle(getRService().getStyle("Animations.PopUpMenu.Center"));
		...
		if (rootHeight > anchorRect.top) {
			...
			window.setAnimationStyle(getRService().getStyle("Animations.PopDownMenu.Center"));
		}
